...
import util
import cv2
from create_neural_style import NeuralStyle, MRF
...
def run(args):
    ...
    for i in range(84):
        ...
        if args.method == 'mrf':
            ...
            style_mask    = np.load("data/"+str(i)+"_mask.npy")
            ...
            model.fit(content_image, style_image, content_mask, style_mask, args.iter, on_epoch_done)
